      ...
      <div className="profile-modal text-center">
        ...
        <div className="mt-3 d-flex">
          <input
            ...
            type="text"
          />
          <button onClick={searchUsers} className="modal-btns pb-3">
            <img
              width="45"
              src="https://img.icons8.com/external-dreamstale-green-shadow-dreamstale/64/000000/external-search-seo-media-dreamstale-green-shadow-dreamstale.png"
            />
          </button>
        </div>
        <div>
          ...
          {users?.map((user) => (
            <div
              key={user._id}
              onClick={() => chatcreate(user._id)}
              className="d-flex user-display align-items-center px-4"
            >
              <img
